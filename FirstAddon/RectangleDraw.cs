...
namespace FirstAddon
{
    ...
    public class RectangleDraw : IAddonDraw
    {
        public bool isFill;
        ...
        public string Description => "Отрисовка прямоугольника";
        ...
        public void EventDragCursor(Bitmap bitmap, Point_Int previousPos, Point_Int currentPos)
        {
            ...
            if (isFill)
            {
                g.FillRectangle(new Pen(brush, Width).Brush, left, top,
                width, height);
            }
            else
                g.DrawRectangle(new Pen(brush, Width), left, top,
                width, height);
        }
        ...
        public void EventUpCursor(Bitmap bitmap, Point_Int Position)
        {
            ...
            if (isFill)
            {
                g.FillRectangle(new Pen(Color, Width).Brush, left, top,
                width, height);
            }
            else
                g.DrawRectangle(new Pen(Color, Width), left, top,
                width, height);
        }
        ...
        {
            RectangleForm rectangle = new RectangleForm(this);
